...
pub const EV_TIMEOUT: ::libc::c_uint = 0x01;
pub const EV_READ: ::libc::c_uint = 0x02;
pub const EV_WRITE: ::libc::c_uint = 0x04;
pub const EV_SIGNAL: ::libc::c_uint = 0x08;
pub const EV_PERSIST: ::libc::c_uint = 0x10;
pub const EV_ET: ::libc::c_uint = 0x20;

pub const EVENT_DBG_NONE: ::libc::c_uint = 0;
pub const EVENT_DBG_ALL: ::libc::c_uint = 0xffffffff;
pub const EVENT_LOG_DEBUG: ::libc::c_uint = 0;
pub const EVENT_LOG_MSG: ::libc::c_uint = 1;
pub const EVENT_LOG_WARN: ::libc::c_uint = 2;
pub const EVENT_LOG_ERR: ::libc::c_uint = 3;
